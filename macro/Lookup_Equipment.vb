...
Set wbExternal = Workbooks.Open Filename:= _
    "\\tecph-naS04\20190117\Indexers\Nino\Train_Equipment_List.xlsx"
...
Se wb = Workbooks("\\tecph-naS04\20190117\Indexers\Nino\Train_Equipment_List.xlsx")

' Or if the workbook running the code is book tool
' Set wb = ThisWorkbook

 'Gets last row of Tool sheet
 Set ws = wb.Sheets("Tag_Index")
 lastrow = ws.Cells(ws.Rows.Count, "B").End(xlUp).Row

'Lookup in External File
Set wsExternal = wbExternal.Sheets("List")
