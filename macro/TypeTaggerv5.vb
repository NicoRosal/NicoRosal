...
On Error GoTo 0
   ...
   Application.ScreenUpdating = False
    ...
    For Each cel In SourceRange3.Offset(0, 47)
        ...
        ElseIf InStr(1, cel.Value, "UTILITY FLOW") > 0 Then
            cel.Offset(0, -39).Value = "Process"
            cel.Offset(0, -38).Value = "Utility Flow Diagram"
        ...
        ElseIf InStr(1, cel.Value, "METHOD STATEMENT") > 0 Then
            cel.Offset(0, -39).Value = "General"
            cel.Offset(0, -38).Value = "Project Engineering Procedure"
            
        ElseIf InStr(1, cel.Value, "PROCESS FLOW") > 0 Then
            cel.Offset(0, -39).Value = "Process"
            cel.Offset(0, -38).Value = "Process Flow Diagram"
        ...
        ElseIf InStr(1, cel.Value, "AUXILIARY FLOW") > 0 Then
            cel.Offset(0, -39).Value = "Process"
            cel.Offset(0, -38).Value = "Process Flow Diagram"
        ...
        ElseIf InStr(1, cel.Value, "AND INSTRUMENT DIAGRAM") > 0 Then
            cel.Offset(0, -39).Value = "Process"
            cel.Offset(0, -38).Value = "P&ID"
        ...
        ElseIf InStr(1, cel.Value, "ISOMET") > 0 Then
            cel.Offset(0, -39).Value = "Piping"
            cel.Offset(0, -38).Value = "Fabrication Isometric Drawing"
        ...
        ElseIf InStr(1, cel.Value, "HOOK UP") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
       ...
       ElseIf InStr(1, cel.Value, "COMPLETION STAGE ARCHITECTURAL DRAWING") > 0 Then
       ...
       ElseIf InStr(1, cel.Value, "GENERAL ARRANGEMENT FOR BUILDINGS AND STRUCTURE") > 0 Then
            cel.Offset(0, -39).Value = "Architectural"
       ...
       ElseIf InStr(1, cel.Value, "MAR ") > 0 Then
       ...
       ElseIf InStr(1, cel.Value, "CONSTRUCTION PERMIT") > 0 Then
            cel.Offset(0, -39).Value = "Construction & Commissioning"
            cel.Offset(0, -38).Value = "Construction Permits/Licence/Permit Plan"
            
       ElseIf InStr(1, cel.Value, "CONSTRUCTION LICENCE") > 0 Then
            cel.Offset(0, -39).Value = "Construction & Commissioning"
            cel.Offset(0, -38).Value = "Construction Permits/Licence/Permit Plan"
            
       ElseIf InStr(1, cel.Value, "CONSTRUCTION PERMIT PLAN") > 0 Then
            cel.Offset(0, -39).Value = "Construction & Commissioning"
            cel.Offset(0, -38).Value = "Construction Permits/Licence/Permit Plan"
       ...
       ElseIf InStr(1, cel.Value, "CEMENT MTO") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
       ...
       ElseIf InStr(1, cel.Value, "CONCRETE AND STRUCTURAL SPECIFICATION") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Concrete and Structural Specifications"
            
       ElseIf InStr(1, cel.Value, "CONCRETESPECIFICATION") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Concrete and Structural Specifications"
       ...
       ElseIf InStr(1, cel.Value, "CULVERTS, BUND WALLS & SUMPS DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Culverts, Bund Walls & Sumps Drawings"
            
       ElseIf InStr(1, cel.Value, "CULVERT") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Culverts, Bund Walls & Sumps Drawings"

       ElseIf InStr(1, cel.Value, "BUNDS") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Culverts, Bund Walls & Sumps Drawings"

       ElseIf InStr(1, cel.Value, "SUMPS") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Culverts, Bund Walls & Sumps Drawings"
            
       ElseIf InStr(1, cel.Value, "DESIGN INTEGRITY") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Design Integrity Documents"

       ElseIf InStr(1, cel.Value, "DRAINAGE & STORM WATER SEWER SYSTEM DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Drainage & Storm Water Sewer System Drawings"
            
       ElseIf InStr(1, cel.Value, "DRAINAGE") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Drainage & Storm Water Sewer System Drawings"
            
       ElseIf InStr(1, cel.Value, "STORM WATER") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Drainage & Storm Water Sewer System Drawings"

       ElseIf InStr(1, cel.Value, "FABRICATION DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
       ...
       ElseIf InStr(1, cel.Value, "FIREPROOFING") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Fireproofing Drawings & Specification"
            
       ElseIf InStr(1, cel.Value, "FIREPROOFING DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Fireproofing Drawings & Specification"
       ...
       ElseIf InStr(1, cel.Value, "GRADING") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Grading Plan, Leveling"
            
       ElseIf InStr(1, cel.Value, "LEVELING") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Grading Plan, Leveling"

       ElseIf InStr(1, cel.Value, "IRRIGATION/LANDSCAPING DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Irrigation/Landscaping Drawings"
            
       ElseIf InStr(1, cel.Value, "IRRIGATION") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Irrigation/Landscaping Drawings"
            
       ElseIf InStr(1, cel.Value, "LANDSCAPING") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Irrigation/Landscaping Drawings"
       ...
       ElseIf InStr(1, cel.Value, "PAVEMENT, SURFACING & SLOPE PROTECTION DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Pavement, Surfacing & Slope Protection Drawings"
        
       ElseIf InStr(1, cel.Value, "PAVEMENT") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Pavement, Surfacing & Slope Protection Drawings"
            
       ElseIf InStr(1, cel.Value, "SURFACING") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Pavement, Surfacing & Slope Protection Drawings"
       ...
       ElseIf InStr(1, cel.Value, "DRAINAGE LAYOUT") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Road, Fencing & Drainage Layout"
            
       ElseIf InStr(1, cel.Value, "ROAD") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Road, Fencing & Drainage Layout"
            
       ElseIf InStr(1, cel.Value, "FENCING") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Road, Fencing & Drainage Layout"
            
       ElseIf InStr(1, cel.Value, "SAND TESTING REPORT") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Sand Testing Reports"

       ElseIf InStr(1, cel.Value, "SCHEDULES & BILL OF MATERIAL") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Schedules & Bill Of Materials"

       ElseIf InStr(1, cel.Value, "SHOP DETAIL") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
       ...
       ElseIf InStr(1, cel.Value, "STRUCTURAL STEEL CALCULATION") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
       ...
       ElseIf InStr(1, cel.Value, "TRENCHING AND UNDERGROUND SERVICES LAYOUTS AND CONCRETE DETAIL") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Trenching and Underground Services Layouts and Concrete Details"
            
       ElseIf InStr(1, cel.Value, "TRENCHING") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Trenching and Underground Services Layouts and Concrete Details"

       ElseIf InStr(1, cel.Value, "BLOCK DIAGRAM") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
            cel.Offset(0, -38).Value = "Block Diagrams"

       ElseIf InStr(1, cel.Value, "BUILDING ELECTRICAL LAYOUT") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
            cel.Offset(0, -38).Value = "Building Electrical Layouts"

       ElseIf InStr(1, cel.Value, "BUILDING MANAGEMENT SYSTEM DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
            cel.Offset(0, -38).Value = "Building Management System Drawings (BMS)"

       ElseIf InStr(1, cel.Value, "BUILDING SMALL POWER AND LIGHTING LAYOUT") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
            cel.Offset(0, -38).Value = "Building Small Power and Lighting Layouts"

       ElseIf InStr(1, cel.Value, "CABLE SIZE CALCULATION") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
       ...
       ElseIf InStr(1, cel.Value, "EARTHING LAYOUT") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
            cel.Offset(0, -38).Value = "Earthing Layouts"

       ElseIf InStr(1, cel.Value, "ELECTRICAL CABLE BLOCK DIAGRAM") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
       ...
       ElseIf InStr(1, cel.Value, "ELECTRICAL DRAWINGS FOR BUILDING SERVICE") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
            cel.Offset(0, -38).Value = "Electrical Drawings For Building Services"

       ElseIf InStr(1, cel.Value, "ELECTRICAL EQUIP. LOCATION & CABLE ROUTING LAYOUT") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
            cel.Offset(0, -38).Value = "Electrical Equip. Location & Cable Routing Layouts"

       ElseIf InStr(1, cel.Value, "ELECTRICAL EQUIPMENT ARRANGEMENT LAYOUT") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
            cel.Offset(0, -38).Value = "Electrical Equipment Arrangement Layouts"

       ElseIf InStr(1, cel.Value, "ELECTRICAL INSTALLATION STANDARD") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
            cel.Offset(0, -38).Value = "Electrical Installation Standards (Power, Lighting, Cable Trench Sections, Earthing etc.)"

       ElseIf InStr(1, cel.Value, "ELECTRICAL INTERCONNECTION DIAGRAM") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
       ...
       ElseIf InStr(1, cel.Value, "ELECTRICAL LOGIC DIAGRAM") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
       ...
       ElseIf InStr(1, cel.Value, "ELECTRICAL SPECIFICATION") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
       ...
       ElseIf InStr(1, cel.Value, "GROUNDING DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
            cel.Offset(0, -38).Value = "Grounding Drawings"

       ElseIf InStr(1, cel.Value, "LEGENDS AND SYMBOL LIST") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
            cel.Offset(0, -38).Value = "Legends and Symbol Lists"

       ElseIf InStr(1, cel.Value, "LIGHTING AND GROUNDING LAYOUT") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
       ...
       ElseIf InStr(1, cel.Value, "POWER AND GROUNDING DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
       ...
       ElseIf InStr(1, cel.Value, "PROTECTION RELAY COORDINATION SETTING") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
       ...
       ElseIf InStr(1, cel.Value, "SCHEMATIC WIRING DIAGRAM") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
       ...
       ElseIf InStr(1, cel.Value, "SINGLE LINE DIAGRAM") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
       ...
       ElseIf InStr(1, cel.Value, "STANDARD CABLE TRAY DETAIL") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
       ...
       ElseIf InStr(1, cel.Value, "STANDARD F&G DETAIL") > 0 Then
            cel.Offset(0, -39).Value = "Fire & Gas"
       ...
       ElseIf InStr(1, cel.Value, "EMERGENCY PROCEDURES MANUAL") > 0 Then
            cel.Offset(0, -39).Value = "HSE"
       ...
       ElseIf InStr(1, cel.Value, "HAZARDOUS SUBSTANCE DATA SHEET") > 0 Then
            cel.Offset(0, -39).Value = "HSE"
       ...
       ElseIf InStr(1, cel.Value, "HEALTH/SAFETY/ENVIRONMENT PROCEDURE") > 0 Then
            cel.Offset(0, -39).Value = "HSE"
            cel.Offset(0, -38).Value = "Health/Safety/Environment Procedures"
            
       ElseIf InStr(1, cel.Value, "HSE PROCEDURE") > 0 Then
            cel.Offset(0, -39).Value = "HSE"
            cel.Offset(0, -38).Value = "Health/Safety/Environment Procedures"
       ...
       ElseIf InStr(1, cel.Value, "PASSIVE FIRE PROTECTION DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "HSE"
            cel.Offset(0, -38).Value = "Passive Fire Protection Drawings"

       ElseIf InStr(1, cel.Value, "PHSR REPORT") > 0 Then
            cel.Offset(0, -39).Value = "HSE"
       ...
       ElseIf InStr(1, cel.Value, "REGISTER OF SAFETY DEVICE") > 0 Then
            cel.Offset(0, -39).Value = "HSE"
            cel.Offset(0, -38).Value = "Register of Safety Devices"

       ElseIf InStr(1, cel.Value, "SAFETY EQUIPMENT DATA SHEET") > 0 Then
            cel.Offset(0, -39).Value = "HSE"
            cel.Offset(0, -38).Value = "Safety Equipment Data Sheets"

       ElseIf InStr(1, cel.Value, "SAFETY EQUIPMENT DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "HSE"
       ...
       ElseIf InStr(1, cel.Value, "SAFETY SPECIFICATION") > 0 Then
            cel.Offset(0, -39).Value = "HSE"
            cel.Offset(0, -38).Value = "Safety Specifications"

       ElseIf InStr(1, cel.Value, "SIL REPORT") > 0 Then
            cel.Offset(0, -39).Value = "HSE"
            cel.Offset(0, -38).Value = "SIL Reports"

       ElseIf InStr(1, cel.Value, "TEST PROCEDURE") > 0 Then
            cel.Offset(0, -39).Value = "HSE"
       ...
       ElseIf InStr(1, cel.Value, "ALL CERTIFIED EQUIPMENT AND ACCESSORIES DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "HVAC"
            cel.Offset(0, -38).Value = "All Certified Equipment and Accessories Drawings"

       ElseIf InStr(1, cel.Value, "ALL HVAC-RELATED CONSTRUCTION SPECIFICATION") > 0 Then
            cel.Offset(0, -39).Value = "HVAC"
            cel.Offset(0, -38).Value = "All HVAC-related Construction Specifications"

       ElseIf InStr(1, cel.Value, "CONTROL LOGIC DIAGRAM") > 0 Then
            cel.Offset(0, -39).Value = "HVAC"
            cel.Offset(0, -38).Value = "Control Logic Diagrams"

       ElseIf InStr(1, cel.Value, "CONTROL SCHEMATIC DIAGRAM") > 0 Then
            cel.Offset(0, -39).Value = "HVAC"
            cel.Offset(0, -38).Value = "Control Schematic Diagrams"

       ElseIf InStr(1, cel.Value, "CONTROL TERMINATION DIAGRAM") > 0 Then
            cel.Offset(0, -39).Value = "HVAC"
            cel.Offset(0, -38).Value = "Control Termination Diagrams"

       ElseIf InStr(1, cel.Value, "COOLING, HEATING, VENTILATION LOAD CALCULATION") > 0 Then
            cel.Offset(0, -39).Value = "HVAC"
       ...
       ElseIf InStr(1, cel.Value, "HVAC GENERAL ARRANGEMENT DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "HVAC"
            cel.Offset(0, -38).Value = "HVAC General Arrangement Drawings"

       ElseIf InStr(1, cel.Value, "INSULATION DETAIL") > 0 Then
            cel.Offset(0, -39).Value = "HVAC"
            cel.Offset(0, -38).Value = "Insulation Details"

       ElseIf InStr(1, cel.Value, "PERFORMANCE DATA AND OPERATIONAL CURVE") > 0 Then
            cel.Offset(0, -39).Value = "HVAC"
            cel.Offset(0, -38).Value = "Performance Data and Operational Curves"

       ElseIf InStr(1, cel.Value, "PIPING SYSTEM VALVES, FITTINGS & ACCESSORIES DRAWING DETAIL") > 0 Then
            cel.Offset(0, -39).Value = "HVAC"
            cel.Offset(0, -38).Value = "Piping System Valves, Fittings & Accessories Drawing Details"

       ElseIf InStr(1, cel.Value, "AUXILIARY RACKS LAYOUT") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
       ...
       ElseIf InStr(1, cel.Value, "CABLE ROUTING DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Cable Routing Drawings"

       ElseIf InStr(1, cel.Value, "CABLE ROUTING LAYOUT") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Cable Routing Layouts"

       ElseIf InStr(1, cel.Value, "CAUSE AND EFFECT DIAGRAM") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Cause and Effect Diagrams"

       ElseIf InStr(1, cel.Value, "CONTROL PANEL LAYOUT") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Control Panel Layouts"

       ElseIf InStr(1, cel.Value, "CONTROL ROOM LAYOUT") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
       ...
       ElseIf InStr(1, cel.Value, "CRITICAL INSTRUMENT CALCULATION") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
       ...
       ElseIf InStr(1, cel.Value, "ESD DIAGRAM") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "ESD Diagrams"

       ElseIf InStr(1, cel.Value, "FAILURE MODES EFFECTS ANALYSIS FOR SHUTDOWN SYSTEM") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Failure Modes Effects Analysis for Shutdown Systems"

       ElseIf InStr(1, cel.Value, "FISCAL METERING DESIGN CALCULATION") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
       ...
       ElseIf InStr(1, cel.Value, "HOOK-UP DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Hook-Up Drawings"

       ElseIf InStr(1, cel.Value, "INSTALLATION AND MOUNTING STANDARD") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Installation and Mounting Standards"

       ElseIf InStr(1, cel.Value, "INSTRUMENT AND DESIGN SPECIFICATION") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
       ...
       ElseIf InStr(1, cel.Value, "GROUNDING INTERCONNECT") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Instrument/Control System Power Distribution, Grounding Interconnects Drawing"
       ...
       ElseIf InStr(1, cel.Value, "INSTRUMENT GENERAL ARRANGEMENT DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
       ...
       ElseIf InStr(1, cel.Value, "I/O LIST") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Instrument Index, I/O List & Alarm List"
            
       ElseIf InStr(1, cel.Value, "INSTRUMENT INDEX") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Instrument Index, I/O List & Alarm List"
            
       ElseIf InStr(1, cel.Value, "ALARM LIST") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Instrument Index, I/O List & Alarm List"
       ...
       ElseIf InStr(1, cel.Value, "INSTRUMENT LOCATION DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Instrument Location Drawings\Layouts"

       ElseIf InStr(1, cel.Value, "INSTRUMENT LOOP DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Instrument Loop Drawings"

       ElseIf InStr(1, cel.Value, "INSTRUMENT WIRING & TERMINATION DIAGRAM") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Instrument Wiring & Termination Diagrams"

       ElseIf InStr(1, cel.Value, "INTERFACE DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Interface Drawings"

       ElseIf InStr(1, cel.Value, "I/O LOADING LAYOUT") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
       ...
       ElseIf InStr(1, cel.Value, "LOGIC DIAGRAM") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Logic Diagrams"

       ElseIf InStr(1, cel.Value, "MARSHALLING CABINET") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Marshalling Cabinets"

       ElseIf InStr(1, cel.Value, "OVERALL CONTROL SYSTEM BLOCK DIAGRAM") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Overall Control System Block Diagrams"

       ElseIf InStr(1, cel.Value, "RELAY SCHEMATIC") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
       ...
       ElseIf InStr(1, cel.Value, "SCADA") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
       ...
       ElseIf InStr(1, cel.Value, "SHUTDOWN LOGIC DIAGRAM") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Shutdown Logic Diagrams"

       ElseIf InStr(1, cel.Value, "SOFTWARE CONFIGURATION DIAGRAM") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Software Configuration Diagrams"

       ElseIf InStr(1, cel.Value, "STANDARD INSTRUMENT DETAIL") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Standard Instrument Details"

       ElseIf InStr(1, cel.Value, "TESTING AND COMMISSIONING PROCEDURE") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Testing and Commissioning Procedures"

       ElseIf InStr(1, cel.Value, "ACCESS MANUAL") > 0 Then
            cel.Offset(0, -39).Value = "Mechanical"
            cel.Offset(0, -38).Value = "Access Manuals"

       ElseIf InStr(1, cel.Value, "ALIGNMENT SPECIFICATION") > 0 Then
            cel.Offset(0, -39).Value = "Mechanical"
            cel.Offset(0, -38).Value = "Alignment Specifications"

       ElseIf InStr(1, cel.Value, "CONDITION MONITORING BASELINE") > 0 Then
            cel.Offset(0, -39).Value = "Mechanical"
            cel.Offset(0, -38).Value = "Condition Monitoring Baselines"

       ElseIf InStr(1, cel.Value, "CRITICAL WELD PROCEDURE") > 0 Then
            cel.Offset(0, -39).Value = "Mechanical"
            cel.Offset(0, -38).Value = "Critical Weld Procedures"

       ElseIf InStr(1, cel.Value, "EQUIPMENT LAYOUT") > 0 Then
            cel.Offset(0, -39).Value = "Mechanical"
       ...
       ElseIf InStr(1, cel.Value, "MECHANICAL EQUIPMENT DATA SHEET") > 0 Then
            cel.Offset(0, -39).Value = "Mechanical"
       ...
       ElseIf InStr(1, cel.Value, "PERFORMANCE CURVE") > 0 Then
            cel.Offset(0, -39).Value = "Mechanical"
            cel.Offset(0, -38).Value = "Performance Curves"

       ElseIf InStr(1, cel.Value, "PLOT PLAN") > 0 Then
            cel.Offset(0, -39).Value = "Mechanical"
       ...
       ElseIf InStr(1, cel.Value, "VESSEL DESIGN CALCULATION") > 0 Then
            cel.Offset(0, -39).Value = "Mechanical"
       ...
       ElseIf InStr(1, cel.Value, "VESSELS & TANKS SPECIFICATION") > 0 Then
            cel.Offset(0, -39).Value = "Mechanical"
       ...
       ElseIf InStr(1, cel.Value, "BASELINE CORROSION READING") > 0 Then
            cel.Offset(0, -39).Value = "Material Management"
            cel.Offset(0, -38).Value = "Baseline Corrosion Readings"

       ElseIf InStr(1, cel.Value, "CATHODIC PROTECTION FIELD TESTING REPORT") > 0 Then
            cel.Offset(0, -39).Value = "Material Management"
            cel.Offset(0, -38).Value = "Cathodic Protection Field Testing Reports"

       ElseIf InStr(1, cel.Value, "COATINGS TEST REPORT") > 0 Then
            cel.Offset(0, -39).Value = "Material Management"
       ...
       ElseIf InStr(1, cel.Value, "MATERIAL SELECTION DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "Material Management"
       ...
       ElseIf InStr(1, cel.Value, "PAINTING SPECIFICATION") > 0 Then
            cel.Offset(0, -39).Value = "Material Management"
       ...
       ElseIf InStr(1, cel.Value, "MAINTENANCE AND PRESERVATION PROCEDURE") > 0 Then
            cel.Offset(0, -39).Value = "Operate and Maintain"
       ...
       ElseIf InStr(1, cel.Value, "SPARES LISTING") > 0 Then
            cel.Offset(0, -39).Value = "Operate and Maintain"
            cel.Offset(0, -38).Value = "Spares Listings"

       ElseIf InStr(1, cel.Value, "SUPPLIER DATA DOSSIER") > 0 Then
            cel.Offset(0, -39).Value = "Operate and Maintain"
            cel.Offset(0, -38).Value = "Supplier Data Dossiers"

       ElseIf InStr(1, cel.Value, "CONTRACTORS FORM FORMAT") > 0 Then
            cel.Offset(0, -39).Value = "Procurement"
       ...
       ElseIf InStr(1, cel.Value, "MATERIAL MANAGEMENT PROCEDURE") > 0 Then
            cel.Offset(0, -39).Value = "Procurement"
       ...
       ElseIf InStr(1, cel.Value, "MATERIAL RELEASE") > 0 Then
            cel.Offset(0, -39).Value = "Procurement"
       ...
       ElseIf InStr(1, cel.Value, "SURPLUS MATERIAL REPORT") > 0 Then
            cel.Offset(0, -39).Value = "Procurement"
            cel.Offset(0, -38).Value = "Surplus Material Reports"

       ElseIf InStr(1, cel.Value, "UNPRICED COPY OF PURCHASE ORDER") > 0 Then
            cel.Offset(0, -39).Value = "Procurement"
            cel.Offset(0, -38).Value = "Unpriced Copy of Purchase Orders (as issued)"

       ElseIf InStr(1, cel.Value, "UNPRICED COPY OF SUBCONTRACT") > 0 Then
            cel.Offset(0, -39).Value = "Procurement"
            cel.Offset(0, -38).Value = "Unpriced Copy of Subcontracts (as issued)"

       ElseIf InStr(1, cel.Value, "CROSSING DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "Pipeline"
            cel.Offset(0, -38).Value = "Crossing Drawings"

       ElseIf InStr(1, cel.Value, "PIPELINE ALIGNMENT SHEET") > 0 Then
            cel.Offset(0, -39).Value = "Pipeline"
            cel.Offset(0, -38).Value = "Pipeline Alignment Sheets,"

       ElseIf InStr(1, cel.Value, "PIPELINE CALCULATION") > 0 Then
            cel.Offset(0, -39).Value = "Pipeline"
            cel.Offset(0, -38).Value = "Pipeline Calculations"

       ElseIf InStr(1, cel.Value, "PIPELINE DATA SHEET") > 0 Then
            cel.Offset(0, -39).Value = "Pipeline"
            cel.Offset(0, -38).Value = "Pipeline Data Sheets"

       ElseIf InStr(1, cel.Value, "PIPELINE GENERAL ARRANGEMENT DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "Pipeline"
       ...
       ElseIf InStr(1, cel.Value, "COMPLIANCE DOCUMENT") > 0 Then
            cel.Offset(0, -39).Value = "Piping"
            cel.Offset(0, -38).Value = "Compliance Documents"

       ElseIf InStr(1, cel.Value, "DESIGN CALCULATION") > 0 Then
            cel.Offset(0, -39).Value = "Piping"
            cel.Offset(0, -38).Value = "Design Calculations"

       ElseIf InStr(1, cel.Value, "DESIGN, FABRICATION AND INSTALLATION SPECIFICATION") > 0 Then
            cel.Offset(0, -39).Value = "Piping"
       ...
       ElseIf InStr(1, cel.Value, "FABRICATION RECORD") > 0 Then
            cel.Offset(0, -39).Value = "Piping"
            cel.Offset(0, -38).Value = "Fabrication Records"

       ElseIf InStr(1, cel.Value, "INSTALLATION PROCEDURE") > 0 Then
            cel.Offset(0, -39).Value = "Piping"
       ...
       ElseIf InStr(1, cel.Value, "PIPING LAYOUT") > 0 Then
            cel.Offset(0, -39).Value = "Piping"
            cel.Offset(0, -38).Value = "Piping Layouts & Plot Plan"
       ...
       ElseIf InStr(1, cel.Value, "PIPING SUPPORT STANDARD") > 0 Then
            cel.Offset(0, -39).Value = "Piping"
            cel.Offset(0, -38).Value = "Piping Support Standards"

       ElseIf InStr(1, cel.Value, "PRESSURE TEST RECORD") > 0 Then
            cel.Offset(0, -39).Value = "Piping"
       ...
       ElseIf InStr(1, cel.Value, "STRESS ANALYSIS REPORT") > 0 Then
            cel.Offset(0, -39).Value = "Piping"
       ...
       ElseIf InStr(1, cel.Value, "CAUSE AND EFFECT CHART") > 0 Then
            cel.Offset(0, -39).Value = "Process"
       ...
       ElseIf InStr(1, cel.Value, "HL/LP INTERFACE DETAIL") > 0 Then
            cel.Offset(0, -39).Value = "Process"
       ...
       ElseIf InStr(1, cel.Value, "PROCESS CALCULATION") > 0 Then
            cel.Offset(0, -39).Value = "Process"
       ...
       ElseIf InStr(1, cel.Value, "PROCESS SAFEGUARDING DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "Process"
       ...
       ElseIf InStr(1, cel.Value, "SUPERVISORY LEVEL OPERATING PROCEDURES") > 0 Then
            cel.Offset(0, -39).Value = "Process"
            cel.Offset(0, -38).Value = "Supervisory Level Operating Procedures for all Process/Utility Systems"
       ...
       ElseIf InStr(1, cel.Value, "SYSTEM DESIGN BASIS REPORT") > 0 Then
            cel.Offset(0, -39).Value = "Process"
       ...
       ElseIf InStr(1, cel.Value, "CONSTRUCTION PLAN") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "Construction, Inspection & Test Plan"
            
       ElseIf InStr(1, cel.Value, "INSPECTION") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "Construction, Inspection & Test Plan"
            
       ElseIf InStr(1, cel.Value, "TEST PLAN") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "Construction, Inspection & Test Plan"

       ElseIf InStr(1, cel.Value, "EQUIPMENT CRITICALITY RATING SHEET") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
       ...
       ElseIf InStr(1, cel.Value, "MATERIAL TRACE ABILITY RECORDS") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "Material Trace ability Report/Records"
            
       ElseIf InStr(1, cel.Value, "MATERIAL TRACE ABILITY REPORT") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "Material Trace ability Report/Records"

       ElseIf InStr(1, cel.Value, "NDE PERSONNEL QUALIFICATION") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "NDE Personnel Qualifications"

       ElseIf InStr(1, cel.Value, "NDE PROCEDURE") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "NDE Procedures"

       ElseIf InStr(1, cel.Value, "NDE") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "NDE Test Reports"

       ElseIf InStr(1, cel.Value, "PRESSURE TESTING PROCEDURE") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "Pressure Testing Procedures"

       ElseIf InStr(1, cel.Value, "QA/QC GROUP ORGANISATION CHART") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "QA/QC Group Organisation Charts"

       ElseIf InStr(1, cel.Value, "QUALITY AUDIT REPORT") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
       ...
       ElseIf InStr(1, cel.Value, "QUALITY MANUAL") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "Quality Manual/Quality System Programme"
            
       ElseIf InStr(1, cel.Value, "QUALITY SYSTEM PROGRAM") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "Quality Manual/Quality System Programme"
       ...
       ElseIf InStr(1, cel.Value, "RADIOGRAPHIC QUALIFICATION PROCEDURE") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "Radiographic Qualification Procedures"

       ElseIf InStr(1, cel.Value, "SURVEILLANCE PLAN") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
       ...
       ElseIf InStr(1, cel.Value, "WELDER QUALIFICATIONS PROGRAM") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "Welder Qualifications Program & Records"
            
       ElseIf InStr(1, cel.Value, "WELDER QUALIFICATIONS RECORD") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "Welder Qualifications Program & Records"

       ElseIf InStr(1, cel.Value, "WELDING PROCEDURE QUALIFICATIONS RECORD") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "Welding Procedure Qualifications Records (PQRs)"

       ElseIf InStr(1, cel.Value, "WELDING PROCEDURE SPECIFICATION") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
       ...
       ElseIf InStr(1, cel.Value, "WELD REPAIR PROCEDURE") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
       ...
       ElseIf InStr(1, cel.Value, "EQUIPMENT AND OUTLET LAYOUTS TELEPHONE, DATA, PA AND MATV SERVICE") > 0 Then
            cel.Offset(0, -39).Value = "TeleCommunication"
            cel.Offset(0, -38).Value = "Equipment and Outlet Layouts Telephone, Data, PA and MATV Services"

       ElseIf InStr(1, cel.Value, "IDF RECORD") > 0 Then
            cel.Offset(0, -39).Value = "TeleCommunication"
            cel.Offset(0, -38).Value = "IDF Records"

       ElseIf InStr(1, cel.Value, "LISTS/BILL OF MATERIAL") > 0 Then
            cel.Offset(0, -39).Value = "TeleCommunication"
            cel.Offset(0, -38).Value = "Lists/Bill Of Materials"

       ElseIf InStr(1, cel.Value, "LOUDSPEAKER LOOP DIAGRAM") > 0 Then
            cel.Offset(0, -39).Value = "TeleCommunication"
       ...
       ElseIf InStr(1, cel.Value, "TELECOM DATA SHEET") > 0 Then
            cel.Offset(0, -39).Value = "TeleCommunication"
       ...
       ElseIf InStr(1, cel.Value, "TECHNICAL BID") > 0 Then
            cel.Offset(0, -39).Value = "Procurement"
            cel.Offset(0, -38).Value = "Contractor's Proposed Supplier List"
			
       ElseIf InStr(1, cel.Value, "PROJECT SPECIFICATION") > 0 Then
            cel.Offset(0, -39).Value = "General"
            cel.Offset(0, -38).Value = "Project Specifications (New, not covered by DGS)"
			
       ElseIf InStr(1, cel.Value, "ADDENDUM") > 0 Then
            cel.Offset(0, -39).Value = "General"
            cel.Offset(0, -38).Value = "Design General Specifications"
			
       ElseIf InStr(1, cel.Value, "DATA SHEET") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Instrument Datasheet"
			
       ElseIf InStr(1, cel.Value, "PIPING DESIGN") > 0 Then
            cel.Offset(0, -39).Value = "Piping"
            cel.Offset(0, -38).Value = "Design, Fabrication and Installation Specifications"
			
       ElseIf InStr(1, cel.Value, "HAZOP") > 0 Then
            cel.Offset(0, -39).Value = "HSE"
            cel.Offset(0, -38).Value = "HAZOP Report and Project Response"
			
       ElseIf InStr(1, cel.Value, "GEOTECHNIC") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Geotechnical & Geophysical Investigation Service Work Plan, Reports & Maps"
			
       ElseIf InStr(1, cel.Value, "TOPOGRAP") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Topographic Drawing of Site"
			
       ElseIf InStr(1, cel.Value, "CIVIL DESIGN") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
            cel.Offset(0, -38).Value = "Design Integrity Documents"
			
       ElseIf InStr(1, cel.Value, "INSTRUMENTATION DIAGRAM") > 0 Then
            cel.Offset(0, -39).Value = "Process"
            cel.Offset(0, -38).Value = "Process Flow Diagrams (PFD)"
			
       ElseIf InStr(1, cel.Value, "LIGHTING LAYOUT") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
            cel.Offset(0, -38).Value = "Lighting and Grounding Layouts"
			
       ElseIf InStr(1, cel.Value, "GROUNDING LAYOUT") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
            cel.Offset(0, -38).Value = "Lighting and Grounding Layouts"
			
       ElseIf InStr(1, cel.Value, "DESIGN BASIS") > 0 Then
            cel.Offset(0, -39).Value = "Process"
            cel.Offset(0, -38).Value = "System Design Basis Reports"
			
       ElseIf InStr(1, cel.Value, "NDT PROC") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "NDE Procedures"
			
       ElseIf InStr(1, cel.Value, "OPERAT") > 0 Then
            cel.Offset(0, -39).Value = "Operate and Maintain"
            cel.Offset(0, -38).Value = "Operating Information"
			
       ElseIf InStr(1, cel.Value, "NDT") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "NDE Test Reports"
			
       ElseIf InStr(1, cel.Value, "PIPING PLAN") > 0 Then
            cel.Offset(0, -39).Value = "Piping"
            cel.Offset(0, -38).Value = "Piping Layouts & Plot Plan"
			
       ElseIf InStr(1, cel.Value, "MR FOR") > 0 Then
            cel.Offset(0, -39).Value = "Procurement"
            cel.Offset(0, -38).Value = "Material Releases"
			
       ElseIf InStr(1, cel.Value, "TEST") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "Construction, Inspection & Test Plan"
			
       ElseIf InStr(1, cel.Value, " BALANCE") > 0 Then
            cel.Offset(0, -39).Value = "Process"
            cel.Offset(0, -38).Value = "Mass Balance"
    
        ElseIf InStr(1, cel.Value, "AS BUILT") > 0 Then
            cel.Offset(0, -25).Value = "As Built"
         
        ElseIf InStr(1, cel.Value, "ASBUILT") > 0 Then
            cel.Offset(0, -25).Value = "As Built"
    ...
    Next cel
       ...
       For Each DT In SourceRange3.Offset(0, 8)

    If DT = "Architectural" Then
        DT.Offset(0, -1).Value = "Documents"
        DT.Offset(0, 2).Value = "Architectural"

        ElseIf DT = "Construction & Commissioning" Then
        DT.Offset(0, -1).Value = "Documents"
        DT.Offset(0, 2).Value = "Construction & Commissioning"

        ElseIf DT = "Civil" Then
        DT.Offset(0, -1).Value = "Documents"
        DT.Offset(0, 2).Value = "Civil & Structural"

        ElseIf DT = "Electrical" Then
        DT.Offset(0, -1).Value = "Documents"
        DT.Offset(0, 2).Value = "Electrical"

        ElseIf DT = "Fire & Gas" Then
        DT.Offset(0, -1).Value = "Documents"
        DT.Offset(0, 2).Value = "Fire & Gas"

        ElseIf DT = "General" Then
        DT.Offset(0, -1).Value = "Documents"
        DT.Offset(0, 2).Value = "General"

        ElseIf DT = "HSE" Then
        DT.Offset(0, -1).Value = "Documents"
        DT.Offset(0, 2).Value = "HSE"

        ElseIf DT = "HVAC" Then
        DT.Offset(0, -1).Value = "Documents"
        DT.Offset(0, 2).Value = "HVAC"

        ElseIf DT = "Instrumentation" Then
        DT.Offset(0, -1).Value = "Documents"
        DT.Offset(0, 2).Value = "Instrumentation"

        ElseIf DT = "Mechanical" Then
        DT.Offset(0, -1).Value = "Documents"
        DT.Offset(0, 2).Value = "Mechanical"

        ElseIf DT = "Material Management" Then
        DT.Offset(0, -1).Value = "Documents"
        DT.Offset(0, 2).Value = "Material Management"

        ElseIf DT = "Operate and Maintain" Then
        DT.Offset(0, -1).Value = "Documents"
        DT.Offset(0, 2).Value = "Operate and Maintainl"

        ElseIf DT = "Procurement" Then
        DT.Offset(0, -1).Value = "Documents"
        DT.Offset(0, 2).Value = "Procurement"

        ElseIf DT = "Pipeline" Then
        DT.Offset(0, -1).Value = "Documents"
        DT.Offset(0, 2).Value = "Pipeline"

        ElseIf DT = "Piping" Then
        DT.Offset(0, -1).Value = "Documents"
        DT.Offset(0, 2).Value = "Piping"

        ElseIf DT = "Process" Then
        DT.Offset(0, -1).Value = "Documents"
        DT.Offset(0, 2).Value = "Process"

        ElseIf DT = "Quality Control" Then
        DT.Offset(0, -1).Value = "Documents"
        DT.Offset(0, 2).Value = "Quality Control"

        ElseIf DT = "TeleCommunication" Then
        DT.Offset(0, -1).Value = "Documents"
        DT.Offset(0, 2).Value = "TeleCommunication"
...
Private Sub GetPrelimInfo_Click()


Dim SourceRange2 As Range, cel As Range
...
On Error GoTo 0
   ...
   For Each fileform In SourceRange2.Offset(0, 29)
    ...
    Next fileform
      ...
      Plant = InputBox("Plant Name", "Plant", "")
      
    
     SourceRange2.Offset(0, 26).Value = "ADNOC Gas Processing"
     SourceRange2.Offset(0, 11).Value = Plant
     
  For Each cel In SourceRange2

    If InStr(1, cel.Value, "22_5238") > 0 Then
        cel.Offset(0, 14).Value = "5238"
        cel.Offset(0, 15).Value = "BU HASA - HABSHAN GAS PIPELINE"
        cel.Offset(0, 16).Value = "NPCC"
        cel.Offset(0, 27).Value = "13523801"
        cel.Offset(0, 28).Value = "Not Found"
        
    ElseIf InStr(1, cel.Value, "01_1100") > 0 Then
        cel.Offset(0, 14).Value = "1100"
        cel.Offset(0, 15).Value = "ABU DHABI GAS EXTRACTION PLANT"
        cel.Offset(0, 16).Value = "FLUOR MELTD"
        cel.Offset(0, 27).Value = "80000BB"
        cel.Offset(0, 28).Value = "Not Found"
