...
Sub PiperunIdentify()
	...
	For Each cel in SourceRange3.Offset(0,5)
	
		If Instr(1, cel.Value, "PIPERUN") > 0 Then
		call PiperunIdentifyUnit()
...
Sub PiperunIdentifyUnit()
		
	For Each cel In SourceRange3.Offset(0,1)
            
         If InStr(1, cel.Value, "-511A-") > 0 Then
            cel.Offset(0, 6).Value = "Maqta"
            cel.Offset(0, 7).Value = "511A"
