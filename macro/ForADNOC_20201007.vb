...
On Error GoTo 0
    ...
    For Each cel In SourceRange3.Offset(0, 47)
        ...
        ElseIf InStr(1, cel.Value, "INSTRUMENT LOOP") > 0 Then
       ...
       ElseIf InStr(1, cel.Value, "INTERMEDIATE STAGE ARCHITECTURAL DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "Architectural"
       ...
       ElseIf InStr(1, cel.Value, "COMMISSIONING DOCUMENT") > 0 Then
            cel.Offset(0, -39).Value = "Construction & Commissioning"
            cel.Offset(0, -38).Value = "Commissioning Documents"

       ElseIf InStr(1, cel.Value, "COMMISSIONING RECORDS & REPORT") > 0 Then
            cel.Offset(0, -39).Value = "Construction & Commissioning"
       ...
       ElseIf InStr(1, cel.Value, "CIVIL MISCELLANEOU") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
       ...
       ElseIf InStr(1, cel.Value, "CONCRETE TEST RESULT") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
       ...
       ElseIf InStr(1, cel.Value, "DESIGN INTEGRITY DOCUMENT") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
       ...
       ElseIf InStr(1, cel.Value, "FOUNDATION DRAWINGS/DETAIL") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
       ...
       ElseIf InStr(1, cel.Value, "SHOP DETAIL DRAWING") > 0 Then
            cel.Offset(0, -39).Value = "Civil"
       ...
       ElseIf InStr(1, cel.Value, "ELECTRICAL LOAD ANALYSI") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
       ...
       ElseIf InStr(1, cel.Value, "ELECTRICAL MISCELLANEOU") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
       ...
       ElseIf InStr(1, cel.Value, "ELECTRICAL SYSTEM STUDIE") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
       ...
       ElseIf InStr(1, cel.Value, "WIRING DIAGRAM") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
            cel.Offset(0, -38).Value = "Schematic Wiring Diagrams"

       ElseIf InStr(1, cel.Value, "SHORT CIRCUIT STUDIE") > 0 Then
            cel.Offset(0, -39).Value = "Electrical"
       ...
       ElseIf InStr(1, cel.Value, "OVERALL F&G SYSTEM BLOCK DIAGRAMS, I/O LOADING & CABINET LAYOUT") > 0 Then
            cel.Offset(0, -39).Value = "Fire & Gas"
       ...
       ElseIf InStr(1, cel.Value, "REPORTS & RECORDS") > 0 Then
            cel.Offset(0, -39).Value = "General"
            cel.Offset(0, -38).Value = "Reports & Records"
            
       ElseIf InStr(1, cel.Value, "RECORDS") > 0 Then
            cel.Offset(0, -39).Value = "General"
            cel.Offset(0, -38).Value = "Reports & Records"
       ...
       ElseIf InStr(1, cel.Value, "ACCIDENT REPORT") > 0 Then
       ...
       ElseIf InStr(1, cel.Value, "LIST OF PROPOSED DISPOSAL SITE") > 0 Then
            cel.Offset(0, -39).Value = "HSE"
       ...
       ElseIf InStr(1, cel.Value, "CABLE SCHEDULE") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Instrument Cable Schedule"
       ...
       ElseIf InStr(1, cel.Value, "INSTRUMENTATION DATASHEET") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Instrument Datasheet"
            
       ElseIf InStr(1, cel.Value, "INSTRUMENTATION DATA SHEET") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Instrument Datasheet"
       ...
       ElseIf InStr(1, cel.Value, "JUNCTION BOX SCHEDULE") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Instrument Junction Box Schedule"
            
       ElseIf InStr(1, cel.Value, "JB SCHEDULE") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Instrument Junction Box Schedule"
       ...
       ElseIf InStr(1, cel.Value, "INSTRUMENT LOCATION") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Instrument Location Drawings\Layouts"
       ...
       ElseIf InStr(1, cel.Value, "INSTRUMENT WIRING") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Instrument Wiring & Termination Diagrams"
            
       ElseIf InStr(1, cel.Value, "TERMINATION DIAGRAM") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Instrument Wiring & Termination Diagrams"
       ...
       ElseIf InStr(1, cel.Value, "BOM") > 0 Then
            cel.Offset(0, -39).Value = "Instrumentation"
            cel.Offset(0, -38).Value = "Lists/Bill Of Materials"
       ...
       ElseIf InStr(1, cel.Value, "ENGINEERING REPORTS & CALCULATION PACKAGE") > 0 Then
       ...
       ElseIf InStr(1, cel.Value, "CAUSE AND EFFECT") > 0 Then
            cel.Offset(0, -39).Value = "Process"
            cel.Offset(0, -38).Value = "Cause and Effect Charts"
       ...
       ElseIf InStr(1, cel.Value, "SUPERVISORY LEVEL OPERATING PROCEDURES FOR ALL PROCESS/UTILITY SYSTEM") > 0 Then
            cel.Offset(0, -39).Value = "Process"
       ...
       ElseIf InStr(1, cel.Value, "MATERIAL TRACE ABILITY REPORT/RECORD") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
       ...
       ElseIf InStr(1, cel.Value, "MATERIAL TRACE ABILITY RECORD") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "Material Trace ability Report/Records"
       ...
       ElseIf InStr(1, cel.Value, "QA ORGANISATION CHART") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "QA/QC Group Organisation Charts"
            
       ElseIf InStr(1, cel.Value, "QC ORGANISATION CHART") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "QA/QC Group Organisation Charts"
            
       ElseIf InStr(1, cel.Value, "ORGANISATION CHART") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "QA/QC Group Organisation Charts"
            
       ElseIf InStr(1, cel.Value, "ORGANIZATION CHART") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "QA/QC Group Organisation Charts"
       ...
       ElseIf InStr(1, cel.Value, "WELDER QUALIFICATIONS PROGRAM & RECORD") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
       ...
       ElseIf InStr(1, cel.Value, "PQR") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "Welding Procedure Qualifications Records (PQRs)"
       ...
       ElseIf InStr(1, cel.Value, "WPS") > 0 Then
            cel.Offset(0, -39).Value = "Quality Control"
            cel.Offset(0, -38).Value = "Welding Procedure Specifications (WPS)"
       ...
       ElseIf InStr(1, cel.Value, "TELECOM SPECIFICATION") > 0 Then
            cel.Offset(0, -39).Value = "TeleCommunication"
